...
KMs = numDUEs / numCUE;
%numDUE = 20;
sumRate_maxSum = zeros(length(KMs), 1);
minRate_maxSum = zeros(length(KMs), 1);
sumRate_maxMin = zeros(length(KMs), 1);
minRate_maxMin = zeros(length(KMs), 1);
%%

parfor ind = 1 : length(KMs)
    d_avg = d_avg_;
    numDUE = numDUEs(ind);
...
sumRate_maxSum2 = zeros(length(KMs), 1);
minRate_maxSum2 = zeros(length(KMs), 1);
sumRate_maxMin2 = zeros(length(KMs), 1);
minRate_maxMin2 = zeros(length(KMs), 1);
%%
parfor ind = 1 : length(KMs)
    d_avg = d_avg_;
    numDUE = numDUEs(ind);
...
MarkerSize = 6;
figure
plot(KMs, sumRate_maxSum, 'k-s', 'LineWidth', LineWidth, 'MarkerSize', MarkerSize)
hold on
plot(KMs, sumRate_maxMin, 'b-o', 'LineWidth', LineWidth, 'MarkerSize', MarkerSize)
hold on
plot(KMs, sumRate_maxSum2, 'k--s', 'LineWidth', LineWidth, 'MarkerSize', MarkerSize)
hold on
plot(KMs, sumRate_maxMin2, 'b--o', 'LineWidth', LineWidth, 'MarkerSize', MarkerSize)
grid on
...
figure
plot(KMs, minRate_maxSum, 'k-s', 'LineWidth', LineWidth, 'MarkerSize', MarkerSize)
hold on
plot(KMs, minRate_maxMin, 'b-o', 'LineWidth', LineWidth, 'MarkerSize', MarkerSize)
hold on
plot(KMs, minRate_maxSum2, 'k--s', 'LineWidth', LineWidth, 'MarkerSize', MarkerSize)
hold on
plot(KMs, minRate_maxMin2, 'b--o', 'LineWidth', LineWidth, 'MarkerSize', MarkerSize)
grid on
legend('P_{max}^c = 23 dBm, Algorithm 1', 'P_{max}^c = 23 dBm, Algorithm 2',...
'P_{max}^c = 17 dBm, Algorithm 1', 'P_{max}^c = 17 dBm, Algorithm 2')
xlabel('K/M', 'interpreter','latex')
