...
MarkerSize = 6;
figure
%x=[0.001, 0.003, 0.005, 0.007, 0.01, 0.03, 0.05, 0.07, 0.1];
%y=interp1(KMs, sumRate_maxSum, x, 'spline');
%plot(KMs, sumRate_maxSum, 'b-o', x, y);
ind = [1,2,3];
...
set(gca, 'xTick', ind);
set(gca, 'xTickLabel', {'0.001', '0.01', '0.1'});
